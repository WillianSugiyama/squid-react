...
export const GamePage = () => {
  ...
  const startGame = () => {
    ...
    setTimeout(() => {
      ...
      const exitedPersons = [...deadPersons, ...calculedPerson.filter((person: Person) => !person.isActive)]
      ...
      endGameVotes >= (personsRemaining.length / 2) ? setGameVisibility(false): setGameVisibility(true)
